...
function App() {
  ...
  //Filtro para obtener las autorizaciones buscadas.
  // const autorizacionesFiltrados = autorizacion.filter( aut => 
  //     aut.estado.toLowerCase().includes(busqueda.toLowerCase()));
  
  const autorizacionesFiltrados = busqueda 
      ? autorizacion.filter( aut => aut.estado === busqueda)
      : autorizacion;
    ...
    <>
      ...
      <div className="container min-vh-100 py-5">
        ...
        {/* Campo para busquedas*/}
          <label className="form-label">Busqueda por Estado </label>
          <select className="form-select form-select-sm border border-secondary"
            // value={aut.estado}}
            value={busqueda}
        ...
        <div className="table-responsive">
          <table className="table table-bordered table-striped">
            ...
            <tbody className="text-center">
              ...
              {autorizacionesFiltrados.map(aut => (
                <tr key={aut.id}>
                  <td>{aut.id}</td>
